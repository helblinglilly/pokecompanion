...
- We would like to build a native app for this website at some point, and not having a standalone API that publishes its schema complicates this
...
## A new game has released? Where is it?
