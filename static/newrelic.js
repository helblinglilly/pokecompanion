...
(() => {
		...
		r = {
				...
				function a() {
					...
					return (
						...
						o
							.split('')
							.map((e) =>
								'x' === e ? i(t, r++).toString(16) : 'y' === e ? ((3 & i()) | 8).toString(16) : e
							)
							.join('')
					);
				}
					...
					e &&
						...
						(d.has(t) ||
							...
							Object.keys(c).forEach((e) => {
								void 0 === l[e] &&
									(c[e]?.forEach((t) => (0, o.p)('rumresp-' + e, [!1], void 0, t, r)), (l[e] = !1));
							}),
							d.add(t),
							(function () {
								let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
			...
			7806: (e, t, r) => {
				...
				function N(e) {
					...
					return (
						!l.il || T[t.debugId]++ || ((T[t.debugId] = 1), s(t).inPlace(window.history, R, '-')),
						t
					);
				}
				var O = r(3239);
	...
	((o.m = r),
		...
		(o.u = (e) =>
			({ 111: 'nr-spa', 164: 'nr-spa-compressor', 433: 'nr-spa-recorder' })[e] + '-1.253.0.min.js'),
		...
		(() => {
			...
			class _ extends E.w {
				...
				getBucket(e, t, r, n) {
					...
					return (
						o || ((o = this.aggregatedData[e][t] = { params: r || {} }), n && (o.custom = n)),
						o
					);
				}
				get(e, t) {
